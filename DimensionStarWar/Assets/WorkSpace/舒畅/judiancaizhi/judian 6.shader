    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_6370 = (_Center.g+(_Height*_HologarmGrowup));
                float node_1205 = step(i.posWorld.g,node_6370);
                clip(node_1205 - 0.5);
////// Lighting:
////// Emissive:
                float4 node_9919 = _Time;
                float2 node_6217 = (i.uv0+node_9919.g*float2(0.2,0.3));
                float4 _node_5163_var = tex2D(_node_5163,TRANSFORM_TEX(node_6217, _node_5163));
                float3 emissive = ((pow(1.0-max(0,dot(normalDirection, viewDirection)),2.0)*_node_5163_var.r*_liuwense.rgb)+(step(i.posWorld.g,(node_6370+0.1))-node_1205));
                float4 node_443 = tex2D(_node_8761,TRANSFORM_TEX(i.uv0, _node_8761));
                float2 node_1088 = ((i.uv0*float2(2,2))+node_9919.g*float2(-0.01,0.01));
                float4 node_7349 = tex2D(_node_8761,TRANSFORM_TEX(node_1088, _node_8761));
                float2 node_4510 = (i.uv0+node_9919.g*float2(0.005,-0.01));
