...
///////// Gloss:
                ...
                float gloss = 1.0 - (_roughess_var.r*_R); // Convert roughness to gloss
                float perceptualRoughness = (_roughess_var.r*_R);
...
////// Specular:
                ...
                float3 specularColor = (_metallic_var.r*_M);
...
////// Emissive:
                float4 node_6578 = _Time;
                float2 node_4448 = (i.uv0*float2(2,2));
                float2 node_773 = (node_4448+node_6578.g*float2(0.2,0.3));
                float4 _liuwen1_var = tex2D(_liuwen1,TRANSFORM_TEX(node_773, _liuwen1));
                float2 node_1043 = (node_4448+node_6578.g*float2(-0.3,-0.2));
