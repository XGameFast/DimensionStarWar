...
////// Emissive:
                ...
                float2 node_2823 = (i.uv0+node_4597.g*float2(0.2,0.3));
                float4 node_8958 = tex2D(_node_2203,TRANSFORM_TEX(node_2823, _node_2203));
                float2 node_9790 = (i.uv0+node_4597.g*float2(-0.35,-0.05));
