...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:1,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:2,rntp:3,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4013,x:33354,y:32759,varname:node_4013,prsc:2|diff-2263-RGB,spec-2422-OUT,gloss-310-OUT,normal-7642-RGB,emission-6344-OUT,transm-2840-OUT,clip-842-OUT;n:type:ShaderForge.SFN_Tex2d,id:2263,x:32308,y:32416,ptovrint:False,ptlb:base color,ptin:_basecolor,varname:node_2263,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:bd149c749b34d476b8fdde36f32a088f,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:8959,x:32308,y:33133,ptovrint:False,ptlb:AO,ptin:_AO,varname:node_8959,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:1636a2c4ce8bb421896554b69bc0e1d5,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:3236,x:32308,y:32592,ptovrint:False,ptlb:metallic,ptin:_metallic,varname:node_3236,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:97a76e6873524411984c49adb4f96ccc,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:7642,x:32308,y:32949,ptovrint:False,ptlb:normal,ptin:_normal,varname:node_7642,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:f9407c26a6d6443a9a4ef558cd5484ae,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:6232,x:32308,y:32771,ptovrint:False,ptlb:roughess,ptin:_roughess,varname:node_6232,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:00199f29b66294efbb6940944b03658a,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:6066,x:31592,y:33449,ptovrint:False,ptlb:liuwen1,ptin:_liuwen1,varname:node_6066,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:2a9af0d6364f8da43bc827ff5408c4a9,ntxv:0,isnm:False|UVIN-773-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:2732,x:31592,y:33631,ptovrint:False,ptlb:liuwen2,ptin:_liuwen2,varname:node_2732,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:d22778733a18de44d8da6d6b0d744ff1,ntxv:0,isnm:False|UVIN-1043-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:9400,x:31452,y:33981,ptovrint:False,ptlb:rongjietex,ptin:_rongjietex,varname:node_9400,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:0839562779f0c0543aaa239b78bd12b9,ntxv:0,isnm:False|UVIN-9436-OUT;n:type:ShaderForge.SFN_TexCoord,id:4003,x:31035,y:33469,varname:node_4003,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:4448,x:31214,y:33469,varname:node_4448,prsc:2|A-4003-UVOUT,B-6759-OUT;n:type:ShaderForge.SFN_Vector2,id:6759,x:31035,y:33617,varname:node_6759,prsc:2,v1:2,v2:2;n:type:ShaderForge.SFN_Panner,id:773,x:31393,y:33449,varname:node_773,prsc:2,spu:0.2,spv:0.3|UVIN-4448-OUT;n:type:ShaderForge.SFN_Panner,id:1043,x:31393,y:33638,varname:node_1043,prsc:2,spu:-0.3,spv:-0.2|UVIN-4448-OUT;n:type:ShaderForge.SFN_Add,id:9670,x:31786,y:33599,varname:node_9670,prsc:2|A-6066-RGB,B-2732-R;n:type:ShaderForge.SFN_Multiply,id:7024,x:31965,y:33577,varname:node_7024,prsc:2|A-2469-RGB,B-9670-OUT,C-6476-OUT;n:type:ShaderForge.SFN_Color,id:2469,x:31773,y:33396,ptovrint:False,ptlb:liuwen color,ptin:_liuwencolor,varname:node_2469,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.06617647,c2:0.3431034,c3:1,c4:1;n:type:ShaderForge.SFN_Vector1,id:6476,x:31786,y:33747,varname:node_6476,prsc:2,v1:2;n:type:ShaderForge.SFN_Multiply,id:9436,x:31251,y:33981,varname:node_9436,prsc:2|A-4003-UVOUT,B-9513-OUT;n:type:ShaderForge.SFN_Vector2,id:9513,x:31057,y:33999,varname:node_9513,prsc:2,v1:6,v2:2;n:type:ShaderForge.SFN_Step,id:276,x:31724,y:34028,varname:node_276,prsc:2|A-9400-R,B-6045-OUT;n:type:ShaderForge.SFN_Slider,id:2907,x:31026,y:34189,ptovrint:False,ptlb:rongjie,ptin:_rongjie,varname:node_2907,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_RemapRange,id:7970,x:31556,y:34247,varname:node_7970,prsc:2,frmn:0,frmx:1,tomn:0,tomx:1.1|IN-6045-OUT;n:type:ShaderForge.SFN_Step,id:842,x:31736,y:34232,varname:node_842,prsc:2|A-9400-R,B-7970-OUT;n:type:ShaderForge.SFN_Subtract,id:9046,x:31929,y:34168,varname:node_9046,prsc:2|A-842-OUT,B-276-OUT;n:type:ShaderForge.SFN_Add,id:963,x:32252,y:33703,varname:node_963,prsc:2|A-7024-OUT,B-3067-OUT;n:type:ShaderForge.SFN_Multiply,id:3067,x:32161,y:34168,varname:node_3067,prsc:2|A-9046-OUT,B-6990-RGB;n:type:ShaderForge.SFN_Color,id:6990,x:31929,y:34361,ptovrint:False,ptlb:rongjiebian color,ptin:_rongjiebiancolor,varname:node_6990,prsc:2,glob:False,taghide:False,taghdr:True,tagprd:False,tagnsco:False,tagnrm:False,c1:0.09558821,c2:0.9251521,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:9534,x:32421,y:33526,varname:node_9534,prsc:2|A-7991-OUT,B-963-OUT;n:type:ShaderForge.SFN_Vector1,id:7991,x:32277,y:33500,varname:node_7991,prsc:2,v1:1.2;n:type:ShaderForge.SFN_Multiply,id:6344,x:32589,y:33334,varname:node_6344,prsc:2|A-1891-OUT,B-9534-OUT;n:type:ShaderForge.SFN_Slider,id:1891,x:32245,y:33333,ptovrint:False,ptlb:alpha,ptin:_alpha,varname:node_1891,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_RemapRange,id:6045,x:31375,y:34203,varname:node_6045,prsc:2,frmn:0,frmx:1,tomn:0.3,tomx:1|IN-2907-OUT;n:type:ShaderForge.SFN_Multiply,id:2422,x:32734,y:32612,varname:node_2422,prsc:2|A-3236-R,B-245-OUT;n:type:ShaderForge.SFN_Slider,id:245,x:32423,y:32672,ptovrint:False,ptlb:jinshu,ptin:_jinshu,varname:node_245,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.5,max:1.5;n:type:ShaderForge.SFN_Multiply,id:310,x:32756,y:32806,varname:node_310,prsc:2|A-6232-R,B-1654-OUT;n:type:ShaderForge.SFN_Slider,id:1654,x:32440,y:32871,ptovrint:False,ptlb:pinghua,ptin:_pinghua,varname:node_1654,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.5,max:1.5;n:type:ShaderForge.SFN_Slider,id:3226,x:32432,y:33201,ptovrint:False,ptlb:shadow,ptin:_shadow,varname:node_3226,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1.5,max:1.5;n:type:ShaderForge.SFN_Multiply,id:2840,x:32726,y:33128,varname:node_2840,prsc:2|A-8959-RGB,B-3226-OUT;proporder:2263-7642-3236-6232-8959-6066-2732-9400-2469-2907-6990-1891-245-1654-3226;pass:END;sub:END;*/

Shader "Shader Forge/jueseweitiao" {
    Properties {
        ...
        _jinshu ("jinshu", Range(0, 1.5)) = 1.5
        _pinghua ("pinghua", Range(0, 1.5)) = 1.5
        _shadow ("shadow", Range(0, 1.5)) = 1.5
...
///////// Gloss:
                ...
                float gloss = 1.0 - (_roughess_var.r*_pinghua); // Convert roughness to gloss
                float perceptualRoughness = (_roughess_var.r*_pinghua);
...
////// Specular:
                ...
                float3 specularColor = (_metallic_var.r*_jinshu);
...
/////// Diffuse:
                ...
                float3 backLight = max(0.0, -NdotL ) * (_AO_var.rgb*_shadow);
...
////// Emissive:
                float4 node_9859 = _Time;
                float2 node_4448 = (i.uv0*float2(2,2));
                float2 node_773 = (node_4448+node_9859.g*float2(0.2,0.3));
                float4 _liuwen1_var = tex2D(_liuwen1,TRANSFORM_TEX(node_773, _liuwen1));
                float2 node_1043 = (node_4448+node_9859.g*float2(-0.3,-0.2));
