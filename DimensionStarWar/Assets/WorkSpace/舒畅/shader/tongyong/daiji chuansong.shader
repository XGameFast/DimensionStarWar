...
////// Emissive:
                ...
                float2 node_773 = (node_4448+node_4332.g*float2(0.2,0.3));
                float4 _liuwen1_var = tex2D(_liuwen1,TRANSFORM_TEX(node_773, _liuwen1));
                float2 node_1043 = (node_4448+node_4332.g*float2(-0.3,-0.2));
