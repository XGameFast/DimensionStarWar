...
////// Emissive:
                ...
                float2 node_136 = (i.uv1+node_4910.g*float2(0.2,-0.3));
                float4 node_1419 = tex2D(_liuwendissolvetex,TRANSFORM_TEX(node_136, _liuwendissolvetex));
                float2 node_2545 = (i.uv1+node_4910.g*float2(-0.3,-0.2));
