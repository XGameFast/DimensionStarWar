...
Shader "Shader Forge/Skin&Energize" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_9828; uniform float4 _node_9828_ST;
...
////// Emissive:
                ...
                float4 node_9956 = _Time;
                float2 node_136 = (i.uv1+node_9956.g*float2(0.2,-0.3));
                float4 node_1419 = tex2D(_liuwendissolvetex,TRANSFORM_TEX(node_136, _liuwendissolvetex));
                float2 node_2545 = (i.uv1+node_9956.g*float2(-0.3,-0.2));
                ...
                float4 _node_9828_var = tex2D(_node_9828,TRANSFORM_TEX(node_1043, _node_9828));
                float node_3038 = (_wanggestglowtex2_var.g*(node_1419.r*node_1407.r)*_node_9828_var.g);
                float3 emissive = ((node_3038*_wanggecolor.rgb)+saturate(((_node_9828_var.g*_dicolor.rgb)-node_3038))+((node_1952-step(node_9990.b,_Dissolve))*_Dissolvebiancolor.rgb)+(_stglowcolor.rgb*_wanggestglowtex2_var.r));
/// Final Color:
