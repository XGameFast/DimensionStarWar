...
public class ByteReader2
{
	...
	public ByteReader2 (byte[] bytes) { mBuffer = bytes; }
	public ByteReader2 (TextAsset asset) { mBuffer = asset.bytes; }

	/// <summary>
	/// Read the contents of the specified file and return a Byte Reader to work with.
	/// </summary>

	static public ByteReader2 Open (string path)
	{
	...
	static BetterList2<string> mTemp = new BetterList2<string>();

	/// <summary>
	/// Read a single line of Comma-Separated Values from the file.
	/// </summary>

	public BetterList2<string> ReadCSV ()
	{
		mTemp.Clear();
		string line = "";
