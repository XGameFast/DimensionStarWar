...
namespace UnityEngine.XR.iOS
{
    public class AndaARKitUtility
    {
        ...
        public static GameObject CreatePlaneInScene(ARPlaneAnchor arPlaneAnchor ,bool needChangeMeshFilter)
        {
            GameObject plane;
            if (planePrefab != null)
            {
            ...
            return UpdatePlaneWithAnchorTransform(plane, arPlaneAnchor, needChangeMeshFilter);

        }

        public static GameObject UpdatePlaneWithAnchorTransform(GameObject plane, ARPlaneAnchor arPlaneAnchor , bool needChangeMeshFilter)
        {
