...
public class Skill12005 : SkillBallistic
{
    ...
    protected override void StartSkill()
    {
        ...
        GatheringObj.gameObject.SetInto(host.GetComponent<M_1005>().centerForward);
        //初始化特效位置  host为 monster
        //GatheringObj.transform.localPosition += new Vector3() { x = -1.68f, y = 0.91f, z=1.1f };
